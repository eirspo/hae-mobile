<template>
  <div>
    ...
    <div v-transfer-dom>
      <popup v-model="show14" position="bottom" should-scroll-top-on-show>
        <group>
          <cell v-for="i in 20" :key="i" :title="i"></cell>
        </group>
        <div style="padding: 15px;">
          <x-button @click.native="show14 = false" plain type="primary"> Close Me </x-button>
        </div>
      </popup>
    </div>
...
@import '~hae/src/styles/close.less';
