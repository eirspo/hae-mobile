<template>
  <div style="height:100%;">
    ...
    :drawer-style="{'background-color':'#35495e', width: '200px', height: '100vh'}">
      ...
      <div slot="drawer">
        <group title="Drawer demo(beta)" style="margin-top:20px;">
          ...
          <cell title="Github" link="http://github.com/eirspo/hae" value="Star me" @click.native="drawerVisibility = false">
          </cell>
        </group>
      ...
      <view-box ref="viewBox" :body-padding-top="isShowNav ? '46px' : '0'" body-padding-bottom="55px">
        ...
        <tabbar class="vux-demo-tabbar" icon-class="vux-center" v-show="!isTabbarDemo && isShowBar" slot="bottom">
          ...
          <tabbar-item :link="{path:'/component'}" :selected="isDemo" badge="9">
            <span class="demo-icon-22" slot="icon">&#xe633;</span>
            <span slot="label"><span v-if="componentName" class="vux-demo-tabbar-component">{{componentName}}</span><span v-else>Components</span></span>
          </tabbar-item>
          <tabbar-item :link="{path:'/example'}" badge="9">
            <span class="demo-icon-22" slot="icon">&#xe633;</span>
            <span slot="label"><span>Examples</span></span>
          </tabbar-item>
        </tabbar>
